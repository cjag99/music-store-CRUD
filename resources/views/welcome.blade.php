...
<body
    ...
    <header class="fixed left-0 top-0 z-50 flex h-[60px] w-full items-center justify-end bg-[#1A1D5F] pr-6 text-sm">
        @if (Route::has('login'))
            <nav class="flex items-center justify-end gap-4">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-white hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-white dark:hover:border-[#62605b]">
                        Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}"
                        class="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-white hover:border-[#19140035] dark:text-white dark:hover:border-[#3E3E3A]">
                        Log in
                    </a>
    ...
    <main class="w-full max-w-[1280px] lg:max-w-6xl">
        <div class="relative isolate rounded-[30px] bg-[#FFF8E7] px-6 pt-14 lg:px-8">

            <!-- Decorative background shapes (unchanged) -->
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                <div class="text-center">
                    ...
                    <!-- Main Title -->
                    <h1 class="text-balance text-5xl font-extrabold tracking-tight text-black sm:text-7xl">
                        Discover Your Sound
                    </h1>
                    ...
                    <p class="mt-8 text-pretty text-lg font-medium text-black sm:text-xl/8">
                        ...
                        Log in to browse categories, view details, and start your musical journey.
                    </p>

                    <!-- Buttons -->
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="{{ route('login') }}"
                            class="shadow-xs rounded-md bg-[#8B5CF6] px-3.5 py-2.5 text-sm font-semibold text-white hover:bg-[#7C3AED] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#8B5CF6]">
                            Log In
                        </a>

                        <a href="{{ route('register') }}"
                            class="text-sm/6 font-semibold text-black hover:text-[#5A4A45]">
            ...
            <!-- Bottom decorative shape (unchanged) -->
            <div aria-hidden="true"
