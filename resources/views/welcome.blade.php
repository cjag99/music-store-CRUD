...
<body
            ...
            <nav class="flex items-center gap-4">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="rounded-md border border-[#FFF8E722] px-4 py-1.5 text-white/90 transition hover:border-[#FFF8E744] hover:text-white">
                        Panel
                    </a>
                @else
                    <a href="{{ route('login') }}"
                        class="rounded-md border border-transparent px-4 py-1.5 text-white/90 transition hover:border-[#FFF8E722] hover:text-white">
                        Iniciar sesión
                    </a>
    ...
    <main class="mx-auto w-full max-w-[1280px] pt-20 lg:max-w-6xl">
        <section aria-labelledby="hero-title"
            class="relative isolate flex items-center rounded-[30px] border-4 border-[#DAA520] bg-[#FFF8E7]/80 px-6 py-10 lg:px-8">

            <!-- Fondo decorativo superior -->
            <div aria-hidden="true"
                class="absolute inset-x-0 -top-40 -z-10 hidden transform-gpu overflow-hidden blur-3xl sm:-top-80 sm:block">
                <div style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"
                    class="w-144.5 rotate-30 sm:w-288.75 relative left-[calc(50%-11rem)] aspect-[1155/678] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)]">
                </div>
            </div>
            ...
            <div class="mx-auto max-w-2xl py-6 text-center">
                <!-- Título -->
                <h1 id="hero-title"
                    class="text-balance text-4xl font-extrabold tracking-tight text-[#3B2F2F] sm:text-6xl">
                    Encuentra tu sonido
                </h1>

                <!-- Subtítulo -->
                <p class="mt-6 text-pretty text-lg font-medium text-[#3B2F2F]/80 sm:text-xl">
                    Explora una colección seleccionada de instrumentos musicales. Navega por categorías, descubre sus
                    detalles y conecta con tu estilo.
                </p>

                <!-- Botones -->
                <div class="mt-8 flex items-center justify-center gap-x-4">
                    <a href="{{ route('register') }}"
                        class="rounded-md bg-[#C49A3A] px-5 py-2.5 text-sm font-semibold text-[#FFF8E7] transition-all duration-200 ease-out hover:-translate-y-0.5 hover:bg-[#B3872F] hover:shadow-md">
                        Crear cuenta
                    </a>

                    <a href="{{ route('login') }}"
                        class="rounded-md border border-[#C49A3A66] bg-[#FFF8E7]/40 px-5 py-2.5 text-sm font-semibold text-[#3B2F2F] transition-all duration-200 ease-out hover:-translate-y-0.5 hover:border-[#C49A3A] hover:bg-[#C49A3A22] hover:shadow-sm">
                        Iniciar sesión
                    </a>
                </div>

                <!-- Línea de confianza -->
                <p class="mt-5 text-sm text-[#3B2F2F]/60">
            ...
            <div aria-hidden="true"
                class="absolute inset-x-0 top-[calc(100%-10rem)] -z-10 hidden transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-20rem)] sm:block">
                <div style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"
                    class="w-144.5 sm:w-288.75 relative left-[calc(50%+3rem)] aspect-[1155/678] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%+36rem)]">
                </div>
            </div>
        </section>
    </main>
