...
<body
    ...
    <header class="fixed left-0 top-0 z-50 w-full h-14 bg-[#3B2F2F] text-sm flex items-center justify-end px-6">
        @if (Route::has('login'))
        <nav class="flex items-center gap-4">

            @auth
            <a href="{{ url('/dashboard') }}"
                class="rounded-md border border-[#FFF8E722] px-4 py-1.5 text-white/90
                  hover:border-[#FFF8E744] hover:text-white transition">
                Dashboard
            </a>
            @else

            <a href="{{ route('login') }}"
                class="rounded-md border border-transparent px-4 py-1.5 text-white/90
                  hover:border-[#FFF8E722] hover:text-white transition">
                Log in
            </a>
    ...
    <main class="w-full max-w-[1280px] lg:max-w-6xl mx-auto pt-20">
        <section
            aria-labelledby="hero-title"
            class="relative isolate rounded-[30px] bg-[#FFF8E7]/80 px-6 lg:px-8 py-10 flex items-center border-4 border-[#DAA520]">

            <!-- Decorative background shapes -->
            <div aria-hidden="true"
                class="hidden sm:block absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
                <div
                    style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"
                    class="aspect-[1155/678] w-144.5 rotate-30 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:w-288.75 relative left-[calc(50%-11rem)] -translate-x-1/2 sm:left-[calc(50%-30rem)]"></div>
            </div>

            <div class="mx-auto max-w-2xl text-center py-6">

                <!-- Title -->
                <h1
                    id="hero-title"
                    class="text-balance text-4xl sm:text-6xl font-extrabold tracking-tight text-neutral-900">
                    Discover Your Sound
                </h1>

                <!-- Subtitle -->
                <p class="mt-6 text-pretty text-lg sm:text-xl font-medium text-black/80">
                    Explore a curated collection of musical instruments.
                    Browse categories, discover details, and find your sound.
                </p>
                ...
                <div class="mt-8 flex items-center justify-center gap-x-4">
                    ...
                    <a
                        href="{{ route('register') }}"
                        class="rounded-md bg-[#C49A3A] px-5 py-2.5 text-sm font-semibold text-[#FFF8E7]
           transition-all duration-200 ease-out
           hover:bg-[#B3872F] hover:-translate-y-0.5 hover:shadow-md">
                        Create account
                    </a>
                    ...
                    <a
                        href="{{ route('login') }}"
                        class="rounded-md border border-[#C49A3A66] bg-[#FFF8E7]/40 px-5 py-2.5 text-sm font-semibold text-[#3B2F2F]
           transition-all duration-200 ease-out
           hover:bg-[#C49A3A22] hover:border-[#C49A3A] hover:-translate-y-0.5 hover:shadow-sm">
                        Log in
                    </a>
                ...
                <!-- Trust line -->
                <p class="mt-5 text-sm text-black/60">
            ...
            <div aria-hidden="true"
                class="hidden sm:block absolute inset-x-0 top-[calc(100%-10rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-20rem)]">
                <div
                    style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"
                    class="aspect-[1155/678] w-144.5 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:w-288.75 relative left-[calc(50%+3rem)] -translate-x-1/2 sm:left-[calc(50%+36rem)]"></div>
            </div>
