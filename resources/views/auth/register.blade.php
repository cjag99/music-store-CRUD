<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4 flex items-center justify-end">
            <a class="rounded-md text-sm text-[#3B2F2F] underline transition duration-150 ease-in-out hover:text-[#C49A3A] focus:outline-none focus:ring-2 focus:ring-[#C49A3A] focus:ring-offset-2"
                href="{{ route('login') }}">
